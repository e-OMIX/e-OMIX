...
var CdkTreeNode = class _CdkTreeNode {
  ...
  ngOnInit() {
    ...
    this._tree._getExpansionModel().changed.pipe((0, import_operators.map)(() => this.isExpanded), (0, import_operators.distinctUntilChanged)(), (0, import_operators.takeUntil)(this._destroyed)).pipe((0, import_operators.takeUntil)(this._destroyed)).subscribe(() => this._changeDetectorRef.markForCheck());
...
//# sourceMappingURL=chunk-D3R247MY.js.map
